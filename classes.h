...
enum parameters {ELEMENT_LENGTH,CTE_T,CTE_K,CTE_Y,CTE_V,CTE_W,CTE_A,CTE_D,CTE_N};
...
class mesh{
    ...
    public:
        void setParameters(float l,float t,float k,float y,float v,float w,float a,float d,float n){
